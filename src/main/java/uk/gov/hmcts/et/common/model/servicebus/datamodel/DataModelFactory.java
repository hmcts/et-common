...
import uk.gov.hmcts.et.common.model.servicebus.tasks.CloseDataTask;
import uk.gov.hmcts.et.common.model.servicebus.tasks.CreationDataTask;
import uk.gov.hmcts.et.common.model.servicebus.tasks.CreationSingleDataTask;
import uk.gov.hmcts.et.common.model.servicebus.tasks.DataTaskParent;
import uk.gov.hmcts.et.common.model.servicebus.tasks.DetachDataTask;
import uk.gov.hmcts.et.common.model.servicebus.tasks.PreAcceptDataTask;
import uk.gov.hmcts.et.common.model.servicebus.tasks.RejectDataTask;
import uk.gov.hmcts.et.common.model.servicebus.tasks.ResetStateDataTask;
import uk.gov.hmcts.et.common.model.servicebus.tasks.TransferToEcmDataTask;
import uk.gov.hmcts.et.common.model.servicebus.tasks.UpdateDataTask;
...
public class DataModelFactory {
    ...
    public static DataTaskParent getDataModelType(DataModelParent dataModelParent) {
        ...
        } else if (dataModelParent instanceof TransferToEcmDataModel) {
            return new TransferToEcmDataTask(dataModelParent);
        } else {
