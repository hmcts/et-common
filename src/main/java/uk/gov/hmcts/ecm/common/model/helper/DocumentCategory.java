...
public enum DocumentCategory {
    ...
    MISC("C9", "Misc"),
    LEGACY_DOCUMENT_NAMES("C10", "Legacy Document Names"),
    ET1("C11", "ET1", "C1"),
    ...
    APP_TO_EXTEND_TIME_TO_PRESENT_A_RESPONSE("C22", "App to extend time to present a response", "C2"),
    ...
    APP_FOR_A_WITNESS_ORDER_R("C40", "App for a Witness Order - R", "C4"),
    ...
    APP_TO_STRIKE_OUT_ALL_OR_PART_OF_THE_CLAIM("C44", "App to Strike out all or part of the claim", "C4"),
    APP_TO_STRIKE_OUT_ALL_OR_PART_OF_THE_RESPONSE("C45", "App to Strike out all or part of the response", "C4"),
    ...
    WITHDRAWAL_OF_ALL_OR_PART_CLAIM("C49", "Withdrawal of all or part of claim", "C5"),
    COT3("C50", "COT3", "C5"),
    ...
    APP_FOR_A_JUDGMENT_TO_BE_RECONSIDERED_C("C66", "App for a judgment to be reconsidered - C", "C8"),
